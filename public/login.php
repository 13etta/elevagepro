<?php
require_once '../includes/helpers.php'; // Charge config, auth et outils
require_once '../includes/layout.php';  // Charge render_header/footer

require_login(); // Sécurise la page
