...
test('authenticated business pages and export run against the migrated schema', async t => {
  ...
  for(const route of ['/dashboard','/dogs','/dogs/new','/soins','/reminders','/health-tests','/heats','/matings','/pregnancies','/litters','/puppies','/sales','/sales/new','/profitability','/structure','/calendar','/settings','/billing','/account/export','/site/preview']) {
